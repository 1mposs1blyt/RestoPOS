...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "order.item.split": "Разделение блюда",
  "payment.accept": "Приём оплаты",
  "payment.refund": "Возврат",
  "cash.drawer": "Денежный ящик",
  "cash.deposit": "Внесение наличных",
  "cash.withdraw": "Изъятие наличных",
  "cashier.change": "Смена кассира",
  "shift.open": "Открытие кассовой смены",
  "shift.close": "Закрытие кассовой смены",
  "report.x": "Сменный отчёт",
  "report.z": "Закрытие смены с гашением",
  "report.view": "Каталог отчётов",
  "audit.view": "Журнал опасных операций",
  ...
  "staff.attendance": "Табель явок",
  "staff.self": "Своя личная страница",
  "guest.manage": "Список гостей",
  "delivery.view": "Просмотр доставок",
  "delivery.manage": "Управление доставками",
  "document.view": "Просмотр документов",
