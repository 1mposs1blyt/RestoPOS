  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
         ...
         * Раньше он собирался здесь и уходил во внешнюю оболочку через
         * плагин, которого в сборке нет, — каждая марка падала с «plugin
         * shell not found». И подставлялся в него текст без экранирования:
