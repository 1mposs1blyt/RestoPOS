 ...
 *
 * Экспортируется ради теста на чек возврата (`checkout-receipt.test.ts`):
 * возврат собирается от **записанных** платежей, и проверять его состав
 * нужно от тех же строк, что записала продажа, а не от выдуманных вручную.
 */
